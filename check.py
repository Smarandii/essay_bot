...
if __name__ == '__main__':
    text = "kid, kids, pal, pals, folks, mate, mates stupid, dumb, so, guy, guys, teens, too"
    print(shortcut("can't"))

    print(shortcut("people's"))
    print(words("people's"))
    print(words("cannot"))
    print(find_mistakes(text, tumbler=False))
